...
Если требуется добавить в проект ещё одну фичи, то просим модель решить проблему по TDD, сначала подготовить тесты, убедиться, что они падают, потом написать код, потом убедиться, что тесты проходят.
